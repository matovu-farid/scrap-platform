...
const mockScrapes = [
  { id: 1, date: "2023-06-01", duration: "2m 30s", status: "Success", url: "https://example.com" },
  { id: 2, date: "2023-06-02", duration: "1m 45s", status: "Failed", url: "https://example.org" },
  { id: 3, date: "2023-06-03", duration: "3m 15s", status: "Success", url: "https://example.net" },
]
          ...
          <TableBody>
            {filteredScrapes.map((scrape) => (
              <TableRow key={scrape.id}>
                <TableCell className="text-gray-900 dark:text-gray-100">{scrape.date}</TableCell>
                <TableCell className="text-gray-900 dark:text-gray-100">{scrape.url}</TableCell>
                <TableCell className="text-gray-900 dark:text-gray-100">{scrape.duration}</TableCell>
                <TableCell className="text-gray-900 dark:text-gray-100">{scrape.status}</TableCell>
                <TableCell>
                  <Dialog>
                    ...
                    <DialogContent className="bg-white dark:bg-gray-800">
                      <DialogHeader>
                        ...
                        <DialogDescription>Detailed information about the scrape session.</DialogDescription>
                      </DialogHeader>
                      {selectedScrape && (
